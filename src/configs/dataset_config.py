...
EXTRACTED_FEATURE_SET = {
    ...
    'iemocap': ['Average Pitch', 'Pitch Stability (StdDev)', 'Pitch Range (Dynamic Range)', 'Average Loudness', 'Overall Sound Level (dBP)', 'Loudness Variation (StdDev)', 'Avg. Loudness Increase Slope', 'Loudness Decrease Variability', 'Speaking Rate', 'Unvoiced Length Variation (Pause/Consonant Variability)', 'Jitter (Voice Roughness)', 'Shimmer (Voice Breathiness)', 'Harmonics-to-Noise Ratio (Voice Clarity)', 'Hammarberg Variation (Breathiness Stability)', 'Alpha Ratio (Spectral Balance - Voiced)', 'Alpha Ratio (Spectral Balance - Unvoiced)', 'Low Freq Spectral Slope (Voiced)', 'Low Freq Spectral Slope (Unvoiced)', 'Overall Spectral Flux Variation', 'Spectral Flux Variation (Voiced)', 'F1 Frequency (Vowel Openness)', 'F1 Amplitude (Relative to Pitch)', 'MFCC 1 (Overall Spectral Shape)', 'MFCC 1 (Voiced Spectral Shape)', 'MFCC 1 Variation (Overall)', 'MFCC 1 Variation (Voiced)', 'MFCC 2 (Voiced Spectral Energy)', 'MFCC 4 (Overall High-Freq Detail)', 'MFCC 4 (Voiced High-Freq Detail)']
}
